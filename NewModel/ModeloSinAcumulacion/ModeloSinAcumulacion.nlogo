...
to export ;turtle proc
   export-all-plots (word prueba "/" numberAgents "-1-" probability "-curve.csv")
end
...
file-open (word prueba "/" numberAgents "-1-" probability "-turtles.csv")
end
...
to grow-papers
ask patches [
     if random (100 / (probability)) = 1 and papers = 0[
      set papers papers + 1
      set total-papers total-papers + 1
    ]
]
