...
def createTables(directory,numberTest, input):
	...
	for i in range(0,numberTest):
		...
		pub4 = open(directory+'/test'+str(i)+'/testTables/'+'pub4-'+input, 'w')
		pub5 = open(directory+'/test'+str(i)+'/testTables/'+'pub5-'+input, 'w')
		pub6 = open(directory+'/test'+str(i)+'/testTables/'+'pub6-'+input, 'w')
		prob4 = open(directory+'/test'+str(i)+'/testTables/'+'prob4-'+input, 'w')
		prob5 = open(directory+'/test'+str(i)+'/testTables/'+'prob5-'+input, 'w')
		prob6 = open(directory+'/test'+str(i)+'/testTables/'+'prob6-'+input, 'w')
